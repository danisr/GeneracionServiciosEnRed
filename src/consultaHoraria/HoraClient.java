...
public class HoraClient {
	public static void main(String[] args) {
		try {
			...
			String respuesta2 = new String(datagrama2.getData()); //Eliminar espacios del mensaje recibido y luego .trim()	
			
			System.out.println("Mensaje recibido: " + new String(respuesta2.trim())); //Eliminar espacios del mensaje recibido 
